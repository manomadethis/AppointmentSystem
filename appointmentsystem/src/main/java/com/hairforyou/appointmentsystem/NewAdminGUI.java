...
public class NewAdminGUI extends javax.swing.JFrame {
    ...
    public String getSecurityQuestion() {
        return securityQuestionField.getText();
    }
    ...
    */
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        User admin = new Admin("admin", firstName, lastName, role, emailAddress, phoneNumber, username, password, securityAnswer, null);
        LoginForm.addUser(admin);
